...
window.UpdateProductComponent = React.createClass({
    ...
    componentDidMount: function(){
        ...
        // read categories
        this.serverRequestCat = $.get("http://localhost/sermar_api/category/read.php",
            function (categories) {
                this.setState({
        ...
        this.serverRequestProd = $.get("http://localhost/sermar_api/product/read_one.php?id=" + productId,
            function (product) {
    ...
    onSave: function(e){
        ...
        $.ajax({
            url: "http://localhost/sermar_api/product/update.php",
            type : "POST",
