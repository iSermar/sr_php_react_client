window.CreateProductComponent = React.createClass({
    ...
    // on mount, getl all categories and store them in this component's state
    componentDidMount: function() {
        this.serverRequest = $.get("http://localhost/sermar_api/category/read.php", function (categories) {
            this.setState({
    ...
    onSave: function(e){
        ...
        $.ajax({
            url: "http://localhost/sermar_api/product/create.php",
            type : "POST",
